...
- Schema version: 0.26
- Ready: yes
- Artifacts: 42 passed, 0 failed

| Artifact | Document type | Version | Status | Issues | Safety flags |
| --- | --- | --- | --- | --- | --- |
| examples/outputs/artifact_validation.json | artifact_validation | 0.26 | pass | None | live_market_data=False, shell_out=False, private_context=False, broker_execution=False |
| examples/outputs/asset_hub.json | asset_hub | 0.25 | pass | None | live_market_data=False, shell_out=False, private_context=False |
| examples/outputs/audit_trail.json | audit_trail | 0.20 | pass | None | live_market_data=False, shell_out=False |
...
| examples/outputs/guardrail_check.json | guardrail_check | 0.23 | pass | None | live_market_data=False, shell_out=False |
| examples/outputs/guardrail_policy.json | guardrail_policy | 0.23 | pass | None | live_market_data=False, shell_out=False |
| examples/outputs/investment_memo.json | investment_memo_packet | 0.21 | pass | None | live_market_data=False, shell_out=False |
| examples/outputs/investment_memo_review.json | investment_memo_review | 0.21 | pass | None | live_market_data=False, shell_out=False |
| examples/outputs/leveraged_nasdaq_3x.json | simulation_output | 0.2 | pass | None | None |
| examples/outputs/order_review.json | order_review | 0.24 | pass | None | live_market_data=False, shell_out=False, broker_execution=False |
| examples/outputs/order_ticket.json | order_ticket | 0.24 | pass | None | live_market_data=False, shell_out=False, broker_execution=False |
| examples/outputs/package_audit.json | package_audit | 0.11 | pass | None | None |
...
| examples/outputs/stress_matrix.json | stress_matrix | 0.9 | pass | None | None |
| examples/outputs/template_gallery.json | template_gallery | 0.4 | pass | None | None |
| examples/outputs/thesis_dashboard_data.json | thesis_dashboard_data | 0.20 | pass | None | live_market_data=False, shell_out=False |
| examples/outputs/thesis_impact.json | thesis_impact | 0.6 | pass | None | None |
| examples/outputs/watchlist.json | watchlist | 0.10 | pass | None | None |
| examples/outputs/run_ledger.jsonl | run_ledger_entry | 0.5 | pass | None | None |
