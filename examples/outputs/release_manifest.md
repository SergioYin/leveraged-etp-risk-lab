...
| audit/story | 10 | examples/outputs/asset_hub.json, examples/outputs/asset_hub.md, examples/outputs/audit_trail.json, examples/outputs/audit_trail.md, examples/outputs/demo_story.json |
...
- [todo] Confirm release tag v0.29.0 points at the intended commit.
