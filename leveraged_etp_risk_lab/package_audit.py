...
REQUIRED_SCHEMA_FILES = [
    ...
    "docs/scenario-pack-reviewer-receipt.schema.json",
...
REQUIRED_EXAMPLE_OUTPUTS = [
    ...
    "examples/outputs/scenario_pack_reviewer_receipt.json",
    "examples/outputs/scenario_pack_reviewer_receipt.md",
    "examples/outputs/scenario_pack_visual_receipt.json",
    "examples/outputs/scenario_pack_visual_receipt.md",
    "examples/outputs/scenario_pack_visual_receipt.html",
...
TEST_COMMANDS = [
    ...
    ["python", "-m", "leveraged_etp_risk_lab", "asset-hub", "--format", "json"],
    ["python", "-m", "leveraged_etp_risk_lab", "schema-inventory", "--format", "json"],
    ["python", "-m", "leveraged_etp_risk_lab", "artifact-validate", "--format", "json"],
    [
        "python",
        "-m",
    ...
    ["python", "-m", "leveraged_etp_risk_lab", "risk-profile", "--format", "json"],
    [
        "python",
        "-m",
        "leveraged_etp_risk_lab",
    ...
    ["python", "-m", "leveraged_etp_risk_lab", "guardrail-policy", "--policy", "default", "--format", "json"],
    [
        "python",
        "-m",
        "leveraged_etp_risk_lab",
